                    ...
                    <div className="nm-main-grid">
                        ...
                        <div className="nm-right-col">
                            <div className="nm-talk-card">
                                ...
                                <a href="#" className="btn-talk-negative">
                    ...
                    <div className="mpb-main-grid">
                        ...
                        <div className="mpb-right-col">
                            <div className="mpb-talk-card">
                                ...
                                <a href="#" className="btn-talk-positive-banner">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" strokeWidth="2" className="talk-icon">
                                        <path
                                            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z">
            ...
            <div id="manglikPositiveCard"
                ...
                <div className="result-card manglik-positive-card-new">
                    ...
                    <div className="mp-talk-banner-new">
                        ...
                        <a href="#" className="btn-talk-positive">Talk to astrologer &rarr;</a>
                    </div>
                </div>
            </div>
            </>)}
                ...
                <div className="homa-grid">
                    ...
                    <div className="homa-card">
                        ...
                        <div className="homa-card-content">
                            ...
                            <h4 className="homa-card-title">Mangal Shanti Homa</h4>
                            <p className="homa-card-subtitle">(Mars Pacification Homa)</p>
                            <a href="#" className="homa-btn">View Details &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="homa-card">
                        ...
                        <div className="homa-img-wrapper">
                            <img  src="/images/murugar.png" alt="Valli Devayani Samedha Murugan Homa" />
                        </div>
                        <div className="homa-card-content">
                            <div className="homa-card-divider">
                                <span className="hcd-line"></span>
                                <span className="hcd-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                        ...
                                        strokeLinejoin="round">
                                        <path d="M12 2v20"></path>
                                        <path d="M12 2C8 7 8 12 12 15C16 12 16 7 12 2Z"></path>
                                    </svg>
                                </span>
                                <span className="hcd-line"></span>
                            </div>
                            <h4 className="homa-card-title">Valli Devayani Samedha<br />Murugan Homa</h4>
                            <p className="homa-card-subtitle">(Homa for Muruga and his consorts Valli and Devayani)</p>
                            <a href="#" className="homa-btn">View Details &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="homa-card">
                        ...
                        <div className="homa-img-wrapper">
                            <img  src="/images/shiva.png" alt="Shiva Shakti and Kamadeva Homa" />
                        </div>
                        <div className="homa-card-content">
                            <div className="homa-card-divider">
                                <span className="hcd-line"></span>
                            ...
                            <h4 className="homa-card-title">Shiva Shakti and Kamadeva Homa</h4>
                            <p className="homa-card-subtitle">(Shiva-Shakti Homa also by invoking Kamadeva, the God of love)
                            </p>
                            <a href="#" className="homa-btn">View Details &rarr;</a>
                        </div>
                    </div>
...
{!isManglik && <div id="powerfulRemediesSection" className="powerful-remedies-section"
                ...
                <div className="container">
                    ...
                    <div className="remedies-grid">
                        ...
                        <div className="remedy-card hover-glow-orange"
                            style={{background: '#fffbf9', borderRadius: '16px', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingBottom: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.04)', border: '1px solid #ffedd5', transition: 'all 0.4s ease'}}>
                            <div style={{position: 'relative', width: '100%', height: '180px'}}>
                                <img  src="/images/quick.png" alt="Marriage Image Placeholder"
                                    style={{width: '100%', height: '100%', objectFit: 'cover', borderTopLeftRadius: '16px', borderTopRightRadius: '16px', background: '#f1f5f9', display: 'block'}} />
                                <div
                                    style={{position: 'absolute', bottom: '-30px', left: '50%', transform: 'translateX(-50%)', width: '60px', height: '60px', background: '#fff7ed', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', border: '3px solid #ffffff'}}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                                        fill="none" stroke="#ea580c" strokeWidth="1.5">
                                        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                                        <circle cx="9" cy="11" r="4"></circle>
                                        <path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
                                        <path d="M16 7.13a4 4 0 0 1 0 7.75"></path>
                                        <path
                                            d="M12 7.5C11.5 6 9 6 9 8C9 10.5 12 13 12 13C12 13 15 10.5 15 8C15 6 12.5 6 12 7.5Z">
                                        </path>
                                    </svg>
                                </div>
                            </div>
                            <div
                                style={{padding: '45px 25px 0', display: 'flex', flexDirection: 'column', flexGrow: '1', width: '100%', boxSizing: 'border-box'}}>
                                <h3
                                    style={{color: '#7c2d12', fontSize: '20px', fontFamily: '\'Playfair Display\', serif', margin: '0 0 15px 0', lineHeight: '1.3'}}>
                                    Remed for<br />Quick Marriage</h3>
                                <div
                                    style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '15px'}}>
                                    <span style={{height: '1px', width: '20px', background: '#fdba74'}}></span>
                                    <span
                                        style={{width: '6px', height: '6px', background: '#ea580c', transform: 'rotate(45deg)'}}></span>
                                    <span style={{height: '1px', width: '20px', background: '#fdba74'}}></span>
                                </div>
                                <p
                                    style={{color: '#475569', fontSize: '13px', lineHeight: '1.5', marginBottom: '25px', flexGrow: '1'}}>
                                    Powerful rituals and homas to remove delays and bless you with a happy and timely
                                    marriage.</p>
                                <a href="#"
                                    style={{display: 'inline-block', width: '100%', background: '#e87a27', color: '#ffffff', padding: '12px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '14px', transition: 'background 0.3s ease', boxSizing: 'border-box'}}>View
                                    Details &rarr;</a>
                            </div>
                        </div>

                        
                        <div className="remedy-card hover-tilt-green"
                            style={{background: '#f5fcf7', borderRadius: '16px', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingBottom: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.04)', border: '1px solid #dcfce7', transition: 'all 0.4s ease'}}>
                            <div style={{position: 'relative', width: '100%', height: '180px'}}>
                                <img  src="/images/kundali.png" alt="Kundali Image Placeholder"
                                    style={{width: '100%', height: '100%', objectFit: 'cover', borderTopLeftRadius: '16px', borderTopRightRadius: '16px', background: '#f1f5f9', display: 'block'}} />
                                <div
                                    style={{position: 'absolute', bottom: '-30px', left: '50%', transform: 'translateX(-50%)', width: '60px', height: '60px', background: '#f0fdf4', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', border: '3px solid #ffffff'}}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                            ...
                            <div
                                style={{padding: '45px 25px 0', display: 'flex', flexDirection: 'column', flexGrow: '1', width: '100%', boxSizing: 'border-box'}}>
                                <h3
                                    style={{color: '#14532d', fontSize: '20px', fontFamily: '\'Playfair Display\', serif', margin: '0 0 15px 0', lineHeight: '1.3'}}>
                                    Free AI<br />Kundali Report</h3>
                                <div
                                    style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '15px'}}>
                                    <span style={{height: '1px', width: '20px', background: '#86efac'}}></span>
                                    <span
                                        style={{width: '6px', height: '6px', background: '#16a34a', transform: 'rotate(45deg)'}}></span>
                                    <span style={{height: '1px', width: '20px', background: '#86efac'}}></span>
                                </div>
                                <p
                                    style={{color: '#475569', fontSize: '13px', lineHeight: '1.5', marginBottom: '25px', flexGrow: '1'}}>
                                    Get an instant, comprehensive analysis of your birth chart. Discover your planetary
                                    positions, doshas, and predictions powered by cutting-edge AI.</p>
                                <a href="#"
                                    style={{display: 'inline-block', width: '100%', background: '#5a9e64', color: '#ffffff', padding: '12px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '14px', transition: 'background 0.3s ease', boxSizing: 'border-box'}}>Generate
                                    Report &rarr;</a>
                            </div>
                        </div>

                        
                        <div className="remedy-card hover-pulse-pink"
                            style={{background: '#fff5f8', borderRadius: '16px', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', paddingBottom: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.04)', border: '1px solid #fce7f3', transition: 'all 0.4s ease'}}>
                            <div style={{position: 'relative', width: '100%', height: '180px'}}>
                                <img  src="/images/matrimony.png" alt="Matrimony Image Placeholder"
                                    style={{width: '100%', height: '100%', objectFit: 'cover', borderTopLeftRadius: '16px', borderTopRightRadius: '16px', background: '#f1f5f9', display: 'block'}} />
                                <div
                                    style={{position: 'absolute', bottom: '-30px', left: '50%', transform: 'translateX(-50%)', width: '60px', height: '60px', background: '#fdf2f8', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', border: '3px solid #ffffff'}}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                                        fill="none" stroke="#db2777" strokeWidth="1.5">
                                        <circle cx="8" cy="14" r="5"></circle>
                                        <circle cx="16" cy="14" r="5"></circle>
                                        <path d="M12 4l2 3h-4z"></path>
                            ...
                            <div
                                style={{padding: '45px 25px 0', display: 'flex', flexDirection: 'column', flexGrow: '1', width: '100%', boxSizing: 'border-box'}}>
                                <h3
                                    style={{color: '#831843', fontSize: '20px', fontFamily: '\'Playfair Display\', serif', margin: '0 0 15px 0', lineHeight: '1.3'}}>
                                    Matrimony<br />Solutions</h3>
                                <div
                                    style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '15px'}}>
                                    <span style={{height: '1px', width: '20px', background: '#f9a8d4'}}></span>
                                    <span
                                        style={{width: '6px', height: '6px', background: '#db2777', transform: 'rotate(45deg)'}}></span>
                                    <span style={{height: '1px', width: '20px', background: '#f9a8d4'}}></span>
                                </div>
                                <p
                                    style={{color: '#475569', fontSize: '13px', lineHeight: '1.5', marginBottom: '25px', flexGrow: '1'}}>
                                    Astrological guidance and remedies to help find the right match and ensure a
                                    blissful married life.</p>
                                <a href="#"
                                    style={{display: 'inline-block', width: '100%', background: '#cd547a', color: '#ffffff', padding: '12px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '14px', transition: 'background 0.3s ease', boxSizing: 'border-box'}}>View
                                    Details &rarr;</a>
                            </div>
                        </div>
        ...
        {isManglik && <div className="cta-banner-new manglik-cta-banner">
            ...
            <a href="#" className="btn-consult-astrologer">
